...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'pages-login': RouteRecordInfo<'pages-login', '/pages/login', Record<never, never>, Record<never, never>>,
    ...
    'test-type-id': RouteRecordInfo<'test-type-id', '/test/:type/:id', { type: ParamValue<true>, id: ParamValue<true> }, { type: ParamValue<false>, id: ParamValue<false> }>,
